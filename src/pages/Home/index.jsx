		...
		<div className="home page page-shell">
			<div className="page-container p-4">
				<div className="relative scroll-box h-full overflow-y-scroll scrollbar-hidden">
					...
					<div className="info-box h-full flex flex-col justify-center align-center py-0 px-4 md:px-6 lg:px-20 font-bold leading-tight">
					...
					<div className="social-box h-full flex flex-col justify-center align-center py-0 px-4 md:px-6 lg:px-20 font-bold leading-tight">
						...
						<ul className="flex flex-col justify-center items-center">
							<li className="mb-5.5">
								<a
									className="block size-9.5 md:hover:scale-110 md:hover:duration-300"
							...
							<li className="my-5">
								<a className="block size-7 md:hover:scale-110 md:hover:duration-300" href="https://github.com/jopei-liao" target="_blank" rel="noopener noreferrer">
									<div className="img">
							...
							<li>
								<a className="block size-8.5 md:hover:scale-110 md:hover:duration-300" href="mailto:jopei.liao@gmail.com" target="_blank" rel="noopener noreferrer">
									<div className="img">
